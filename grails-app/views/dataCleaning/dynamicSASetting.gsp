<html>
  ...
  <body>
		...
		<g:uploadForm controller="dataCleaning" action="saveConfigDynamic" method="POST">
		...
		<!-- 
	        ...
	        <p>Size: <input id="size" type="range" name="size" min="0.0" max="1.0" value="1" step="0.1" oninput="showRangeValue(id)" /><span id="sizeText"></span></p>
	        <br>
